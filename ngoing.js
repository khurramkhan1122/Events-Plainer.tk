...
var nGoingLi = document.getElementById('nGoingLi');

nGoingLi.setAttribute('class', 'nav-item active');

var i = 0;

database.child('loguser/' + userID + '/notgoing').on('child_added', snapshot => {
    ...
    var colors = ['#4CAF50', '#009688', '#2196F3', '#795548', '#607D8B', '#673AB7'];
        ...
        singleEvDiv.setAttribute('class', 'container styl1 p-3 mb-4 text-dark bg-light rounded')
